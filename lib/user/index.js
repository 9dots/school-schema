...
var _require = require('../utils'),
    lowerCaseUsername = _require.lowerCaseUsername,
...
var editUser = Schema().prop('studentId', firebaseRef).prop('username', username).prop('id', firebaseRef).prop('name', name).required(['id', 'name', 'username'], 'missing_required_field').others(false);
