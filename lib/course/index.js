...
var task = Schema().prop('displayName', displayName).prop('url', url).prop('keyTask', Schema('number').enum([0, 1, 2, 3, 4])).prop('type', activityType).prop('id', Schema('string').faker('random.uuid')).prop('index', Schema('number').multiple(1.0).faker('random.number')).required(['displayName', 'url', 'type', 'index']);
