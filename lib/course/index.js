...
var task = Schema().prop('displayName', displayName).prop('url', url).prop('keyTask', Schema('boolean')).prop('type', activityType).prop('id', Schema('string').faker('random.uuid')).prop('index', Schema('number').multiple(1.0).faker('random.number')).required(['displayName', 'url', 'type', 'index']);
...
var addTask = Schema().prop('course', firebaseRef).prop('draft', firebaseRef).prop('lesson', uuid).prop('url', url).prop('access_token').required(['url', 'course', 'lesson', 'draft']).others(false, 'invalid_keys');
...
var updateTask = Schema().prop('course', firebaseRef).prop('draft', firebaseRef).prop('lesson', uuid).prop('task', uuid).prop('keyTask', Schema('boolean')).prop('displayName', displayName).prop('type', activityType).required(['task', 'course', 'lesson', 'draft']).others(false, 'invalid_keys');
